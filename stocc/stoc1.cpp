...
***********************************************************************/
int64_t StochasticLib1::Hypergeometric (int64_t n, int64_t m, int64_t N) {
   /*
...
int64_t StochasticLib1::HypInversionMod (int64_t n, int64_t m, int64_t N) {
   /* 
   ...
   */
   ...
   if (N != hyp_N_last || m != hyp_m_last || n != hyp_n_last) {
      ...
      hyp_mode = (int64_t)modef;            // mode, integer
...
int64_t StochasticLib1::HypRatioOfUnifoms (int64_t n, int64_t m, int64_t N) {
   /*
...
***********************************************************************/
void StochasticLib1::MultiHypergeometric (int64_t * destination, int64_t * source, int64_t n, int colors) {
   /*
...
int64_t StochasticLib1::BinomialInver (int64_t n, double p) {
   ...
   */   
   ...
   rc = (n + 1) * p;
   bound = (int64_t)(rc + 11.0*(sqrt(rc) + 1.0));
   if (bound > n) bound = n; 
   q = p / (1. - p);
...
***********************************************************************/
void StochasticLib1::Multinomial (int64_t * destination, double * source, int64_t n, int colors) {
   /*
   This function generates a vector of random variates, each with the
   binomial distribution.
...
void StochasticLib1::Multinomial (int64_t * destination, int64_t * source, int64_t n, int colors) {
