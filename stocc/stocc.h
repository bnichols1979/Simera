...
*
* void Multinomial (int64_t * destination, double * source, int64_t n, int colors);
* void Multinomial (int64_t * destination, int64_t * source, int64_t n, int colors);
* Multivariate binomial distribution.
*
* void MultiHypergeometric (int64_t * destination, int64_t * source, int64_t n, int colors);
...
*
* void MultiWalleniusNCHyp (int64_t * destination, int64_t * source, double * weights, int64_t n, int colors);
* Sampling from multivariate Wallenius' noncentral hypergeometric distribution.
*
* void MultiFishersNCHyp (int64_t * destination, int64_t * source, double * weights, int64_t n, int colors);
...
#ifndef MAXCOLORS
   #define MAXCOLORS 10000                // You may change this value
#endif
...
public:
   ...
   void Multinomial (int64_t * destination, double * source, int64_t n, int colors); // Multinomial distribution
   void Multinomial (int64_t * destination, int64_t * source, int64_t n, int colors);// Multinomial distribution
   void MultiHypergeometric (int64_t * destination, int64_t * source, int64_t n, int colors); // Multivariate hypergeometric distribution
...
public:
   ...
   void MultiWalleniusNCHyp (int64_t * destination, int64_t * source, double * weights, int64_t n, int colors); // Multivariate Wallenius noncentral hypergeometric distribution
   void MultiComplWalleniusNCHyp (int64_t * destination, int64_t * source, double * weights, int64_t n, int colors); // Multivariate complementary Wallenius noncentral hypergeometric distribution
   void MultiFishersNCHyp (int64_t * destination, int64_t * source, double * weights, int64_t n, int colors); // Multivariate Fisher's noncentral hypergeometric distribution
   // subfunctions for each approximation method
protected:
...
public:
   ...
   int BernouilliH(int64_t x, double h, double rh, StochasticLib1 *sto); // used by rejection method
...
public:
   CMultiWalleniusNCHypergeometric(int64_t n, int64_t * m, double * odds, int colors, double accuracy=1.E-8); // constructor
   void SetParameters(int64_t n, int64_t * m, double * odds, int colors); // change parameters
   double probability(int64_t * x);                        // calculate probability function
...
public:
   CMultiWalleniusNCHypergeometricMoments(int64_t n, int64_t * m, double * odds, int colors, double accuracy=1.E-8) 
      : CMultiWalleniusNCHypergeometric(n, m, odds, colors, accuracy) {};
   double moments(double * mean, double * stddev, int64_t * combinations = 0);

protected:
   // functions used internally
   double loop(int64_t n, int c);                          // recursive loops
   // data
...
public:
   CMultiFishersNCHypergeometric(int64_t n, int64_t * m, double * odds, int colors, double accuracy = 1E-9); // constructor
   double probability(int64_t * x);                        // calculate probability function
   void mean(double * mu);                                 // calculate approximate mean
